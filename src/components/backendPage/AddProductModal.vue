				...
				<div class="modal-body">
					<form>
						...
						<div class="mb-3">
							...
							<input type="text" class="form-label " id="addProductCategory" v-model="addProduct.data.category"
								placeholder="搞怪系列">
						</div>
						<div class="mb-3">
						...
						<div class="mb-3">
							...
							<input type="text" class="form-label " id="addProductPrice" v-model.number="addProduct.data.price"
								placeholder="售價">
						</div>
						<div class="mb-3">
							<label for="addProductDescription" class="form-label col-3">商品描述</label>
							<input type="text" class="form-label " id="addProductDescription" v-model="addProduct.data.description"
								placeholder="描述">
						</div>
						<div class="mb-3">
						...
						<div class="mb-3">
							...
							<input type="checkbox" class="form-label " id="addProductIs_enabled" v-model="addProduct.data.is_enabled"
								:true-value="1" :false-value="0" placeholder="內容">
						</div>
						<div class="mb-3">
							<div>
								<div class="input-group mb-3">
									<input type="text" class="form-control" placeholder="新增主圖網址(限1個)" aria-label="新增主圖網址(限1個)"
										aria-describedby="button-addon1" v-model="main">
									<button class="btn btn-outline-secondary" type="button" id="button-addon1" @click="mainImage">+</button>
								</div>
								<div class="input-group mb-3">
									<input type="text" class="form-control" placeholder="新增附圖網址(限5個)" aria-label="新增附圖網址(限5個)"
										aria-describedby="button-addon2" v-model="additional">
